...
export function PickupInfo({ locationId }: PickupInfoProps = {}) {
  ...
  const pickupDisplay = resolvePickupDisplay({ restaurant, location });
  const locationTitle = pickupDisplay.title;
  const phoneNumber = pickupDisplay.phoneNumber
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">{pickupDisplay.address}</p>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 whitespace-pre-line">{pickupDisplay.hoursText}</p>
